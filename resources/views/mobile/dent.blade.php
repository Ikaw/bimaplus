        ...
        <div class="row menu-mobile">
            <div class="col-12">
                <ul>
                    ...
                    <hr class="white">
                    <li><a href="/mobile/digital-world" class="font-white"><img src="../images/menu-dw.png" height="25px"></a></li>
                    <hr class="white">
...
<div class="dent">
    <div class="row">
        <div class="col-12">
            <h1 class="font-white title-bold"><strong>Digital</strong></h1>
            <h1 class="font-white title-bold"><strong>World.</strong></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <p class="font-white">Beragam konten digital yang bikin <br>hidupmu makin seru!</p>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <img src="../images/konten-dw.png" width="50%">
        </div>
    </div>
</div>
